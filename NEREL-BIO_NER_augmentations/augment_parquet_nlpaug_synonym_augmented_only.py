...
AUGMENT_PERCENT = 0.1            # 10% of words per doc
...
AUG_STR = f"augmented_only_pword{int(AUGMENT_PERCENT * 100)}"
...
def augment_file(input_path, lang_dir):
    ...
    print(f"📊 Augmented docs: {len(augmented_rows)}")
    print(f"✅ Saved augmented data only: {output_path}")
