    ...
    with open(output_path, "w", encoding="utf-8") as f:
        for doc_id, group in grouped:
            ...
            for _, row in group.iterrows():
                if ' ' in row['text']:
                    continue  # ✅ Skip multi-word entities
...
def process_all_parquet_files(root_dir="./data/parquet", raw_texts_base_dir="./data/texts", output_base="./data/bio_format_sentence_simple_ents"):
