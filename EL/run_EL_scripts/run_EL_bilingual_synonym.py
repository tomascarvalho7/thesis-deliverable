...
def run_training(epochs=3):
    ...
    ru_data_train = pd.read_parquet("./data/parquet_entity_linking_synonym_100/ru/bionnel_ru_train.parquet")
    ru_data_dev = pd.read_parquet("./data/parquet_entity_linking_synonym_100/ru/bionnel_ru_dev.parquet")
    en_data_train = pd.read_parquet("./data/parquet_entity_linking_synonym_100/en/bionnel_en_train.parquet")
    en_data_dev = pd.read_parquet("./data/parquet_entity_linking_synonym_100/en/bionnel_en_dev.parquet")
